...
This repository contains the implementation of fundamental image processing algorithms on an STM32 microcontroller. The project involves histogram analysis, linear spatial filtering (Convolution), and non-linear filtering (Median Filter).
