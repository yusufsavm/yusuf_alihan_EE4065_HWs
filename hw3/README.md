# Embedded Image Processing - Homework 3

> **Course:** Embedded Systems Application  
> **Authors:** > 👤 **Yusuf Oruç** (150720036)  
...
This project demonstrates fundamental image processing algorithms running on an **STM32 Microcontroller**. The system processes images sent from a PC via UART and returns the results.

**Key Implementations:**
1.  **Otsu's Method:** Automatic thresholding for both Grayscale and RGB images.
2.  **Morphological Operations:** Implementation of Erosion, Dilation, Opening, and Closing.

---

## 1️⃣ Question 1: Grayscale Otsu's Thresholding

The STM32 calculates the histogram of a 64x64 grayscale image, determines the optimal threshold using Otsu's variance method, and applies binary thresholding.

| Input Image | Threshold Graph | Output Result |
| :---: | :---: | :---: |
| ![Original](https://github.com/user-attachments/assets/b8f60f85-d335-4e86-b402-e4dd956ab626) | ![Graph](https://github.com/user-attachments/assets/2fd43cc9-413c-4aaa-b739-5af9cb71575a) | ![Result](https://github.com/user-attachments/assets/e39ebb74-aae2-4fee-901f-fec545625443) |

### 💻 STM32 C Implementation (Otsu Algorithm)
